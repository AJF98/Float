    ...
    <div className="min-h-screen text-slate-900">
      ...
      <main>
        ...
        <section className="relative flex min-h-[100svh] items-center overflow-hidden" style={{ backgroundColor: '#0C0805' }}>
          ...
          {/* Decorative concentric rings — right side depth element */}
          <div className="pointer-events-none absolute right-[-220px] top-1/2 -translate-y-1/2 h-[720px] w-[720px] rounded-full" style={{ border: '1px solid rgba(255,107,43,0.08)' }} />
          <div className="pointer-events-none absolute right-[-100px] top-1/2 -translate-y-1/2 h-[520px] w-[520px] rounded-full" style={{ border: '1px solid rgba(255,107,43,0.12)' }} />
          <div className="pointer-events-none absolute right-[40px] top-1/2 -translate-y-1/2 h-[320px] w-[320px] rounded-full" style={{ border: '1px solid rgba(255,107,43,0.18)' }} />
          ...
          <div className="relative z-10 mx-auto w-full max-w-6xl px-4 py-28 lg:px-8 lg:py-36">
            <div style={{ maxWidth: '680px' }}>
              ...
              {/* Headline — Fraunces Black, tight leading */}
              <h1
                className="mt-10 text-[64px] leading-none text-white sm:text-[80px] lg:text-[96px]"
